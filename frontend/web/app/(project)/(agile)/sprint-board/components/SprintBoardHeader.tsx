    ...
    <div className="flex flex-col bg-white border-b border-[#EAECF0]">
      ...
      <div className="flex items-center justify-between py-5 px-4 md:px-8">
        ...
        <div className="flex items-center gap-6 flex-1 min-w-0">
          ...
          <div className="relative hidden md:block w-[280px] group transition-all duration-300">
            ...
            <input
              ...
              className="block w-full pl-10 pr-4 py-2 bg-[#F9FAFB] border border-[#EAECF0] rounded-xl text-[14px] placeholder-[#667085] focus:outline-none focus:ring-4 focus:ring-[#155DFC]/10 focus:border-[#155DFC] transition-all"
            />
          </div>
        </div>

        {/* Right Corner: Complete Sprint Button */}
        <div className="flex items-center flex-shrink-0 ml-4">
          <button
            onClick={onCompleteSprint}
            disabled={isLoading}
            className="flex items-center justify-center gap-2 px-6 py-2.5 bg-[#155DFC] hover:bg-[#1149C9] text-white rounded-xl text-[14px] font-bold shadow-md hover:shadow-lg active:scale-95 transition-all disabled:opacity-50 whitespace-nowrap"
          >
            {isLoading ? (
      ...
      {/* Mobile Search Row (Only visible on small screens below md) */}
