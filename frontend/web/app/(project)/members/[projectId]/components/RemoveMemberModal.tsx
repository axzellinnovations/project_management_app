    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30 z-50 p-4 sm:p-0">
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8 w-full max-w-sm relative">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button
            type="button"
            className="flex-1 py-2.5 min-h-[44px] rounded border border-gray-300 bg-gray-100 hover:bg-gray-200 font-medium"
            onClick={onClose}
          ...
          <button
            type="button"
            className="flex-1 py-2.5 min-h-[44px] rounded bg-red-600 text-white hover:bg-red-700 font-medium flex items-center justify-center"
            onClick={onConfirm}
            disabled={removeLoading}
          >
