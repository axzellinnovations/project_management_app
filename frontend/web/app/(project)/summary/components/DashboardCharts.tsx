      ...
      <MotionWrapper className="bg-white rounded-xl border border-[#E3E8EF] p-5 shadow-sm hover:shadow-md transition-all duration-200">
        ...
        {taskDistribution.length > 0 ? (
          <div className="relative w-full h-[250px]">
            {/* Precise Center Absolute Overlay matching WorkloadDistribution plain typography */}
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10" style={{ transform: 'translateY(-10px)' }}>
               <h3 className="text-[24px] font-black text-[#101828] leading-none mb-1">{tasks.length}</h3>
            ...
            <SafeChartFrame>
              <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
                ...
                <Tooltip contentStyle={{ borderRadius: '8px', border: '1px solid #E3E8EF', fontSize: '13px' }} />
                <Legend wrapperStyle={{ fontSize: '12px' }} height={20} />
              </PieChart>
            </ResponsiveContainer>
          </SafeChartFrame>
          </div>
