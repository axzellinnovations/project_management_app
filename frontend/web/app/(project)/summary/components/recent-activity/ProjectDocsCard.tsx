  ...
  return (
    <div className="h-full">
      {pagesLoading ? (
        ...
        <div className="space-y-3 bento-no-drag">
          {recentPages.map(page => (
            <Link key={page.id} href={`/project/${projectId}/pages/${page.id}`} className="bento-no-drag flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg border border-transparent hover:border-gray-200 transition-colors group">
